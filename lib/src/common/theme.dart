...
class AppThemeData {
  ...
  static Color primary = Color(0xff009688);
  //
  ...
  Color colorBackground = _backgroundColor;
  Color colorBackgroundGray = Colors.black.withOpacity(0.01);
  Color colorDefaultText;
  Color colorBackgroundDialog;
  MaterialColor primarySwatch = white;
...
//   Color colorBackground = _backgroundDarkColor;
//   Color colorDefaultText = _backgroundColor;
//   Color colorBackgroundGray = Colors.white.withOpacity(0.1);
//   MaterialColor primarySwatch = black;
//   Color colorBackgroundDialog = Color.fromARGB(255, 40, 40, 40);
//   // Color _color2 = Color.fromARGB(80, 80, 80, 80);
//   List<Color> colorsGradient = [Color.fromARGB(80, 80, 80, 80), Colors.black];

//   TextStyle text10white = TextStyle(
//     color: Colors.white,
//     fontWeight: FontWeight.w400,
//     fontSize: 10,
//   );

//   TextStyle text12bold = TextStyle(
//     color: colorDefaultText,
//     fontWeight: FontWeight.w800,
//     fontSize: 12,
//   );

//   TextStyle text12grey = TextStyle(
//     color: Colors.grey,
//     fontWeight: FontWeight.w400,
//     fontSize: 12,
//   );
...
//   TextStyle text14primary = TextStyle(
//     color: colorPrimary,
//     fontWeight: FontWeight.w400,
//     fontSize: 14,
//   );

//   TextStyle text14purple = TextStyle(
//     color: Colors.purple,
//     fontWeight: FontWeight.w400,
//     fontSize: 14,
//   );
...
//   TextStyle text14boldPimary = TextStyle(
//     color: colorPrimary,
//     fontWeight: FontWeight.w800,
//     fontSize: 14,
//   );

//   TextStyle text14grey = TextStyle(
//     color: Colors.grey,
//     fontWeight: FontWeight.w400,
//     fontSize: 14,
//   );

//   TextStyle text14boldWhite = TextStyle(
//     color: Colors.white,
//     fontWeight: FontWeight.w800,
//     fontSize: 14,
//   );

//   TextStyle text14boldWhiteShadow = TextStyle(
//       color: Colors.white,
//       fontWeight: FontWeight.w800,
//       fontSize: 14,
//       shadows: [
...
//   TextStyle text16boldWhite = TextStyle(
//     color: Colors.white,
//     fontWeight: FontWeight.w800,
//     fontSize: 16,
//   );
...
//   TextStyle text18boldPrimary = TextStyle(
//     color: colorPrimary,
//     fontWeight: FontWeight.w800,
//     fontSize: 18,
//   );
...
//   TextStyle text20bold = TextStyle(
//     color: colorDefaultText,
//     fontWeight: FontWeight.w800,
//     fontSize: 20,
//   );

//   TextStyle text20boldPrimary = TextStyle(
//     color: colorPrimary,
//     fontWeight: FontWeight.w800,
//     fontSize: 20,
//   );
...
//   TextStyle text20boldWhite = TextStyle(
//     color: Colors.white,
//     fontWeight: FontWeight.w800,
//     fontSize: 20,
//   );

//   TextStyle text20negative = TextStyle(
//     // text negative color
//     color: colorBackground,
//     fontWeight: FontWeight.w400,
//     fontSize: 20,
...
//   TextStyle text22primaryShadow = TextStyle(
//       // text negative color
//       color: colorPrimary,
//       fontWeight: FontWeight.w800,
//       fontSize: 22,
